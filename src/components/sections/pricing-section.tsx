...
export function PricingSection() {
  const plans = [
    {
      name: "Новичок",
      description: "Попробуй игру бесплатно с друзьями.",
      price: "Бесплатно",
      duration: "навсегда",
      features: [
    ...
    {
      name: "Игрок",
      description: "Для тех, кто играет серьёзно.",
      price: "299 ₽",
      duration: "в месяц",
      features: [
        "До 15 игроков в комнате",
        "8 уникальных ролей",
        "Приватные комнаты",
        "Голосовой чат",
    ...
    {
      name: "Хост",
      description: "Для организаторов турниров и клубов.",
      price: "799 ₽",
      duration: "в месяц",
      features: [
        "До 20 игроков в комнате",
        "Все роли и модификации",
        "Управление турнирами",
        "Роль ведущего (GM)",
        "Кастомные правила",
        "Приоритетная поддержка",
        "Брендирование комнат",
        "Аналитика игр",
        "API для интеграций",
      ],
      cta: "Стать хостом",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400 opacity-70">
                Начни бесплатно, а когда втянешься — открой все возможности игры.
              </p>
            </div>
          </div>
        </ScrollReveal>
